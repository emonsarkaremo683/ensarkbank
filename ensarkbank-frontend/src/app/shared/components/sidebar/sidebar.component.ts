...
export class SidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    { label: 'Divisions', route: '/divisions', icon: 'divisions', roles: [Role.SUPER_ADMIN, Role.ADMIN] },
    { label: 'Districts', route: '/districts', icon: 'districts', roles: [Role.SUPER_ADMIN, Role.ADMIN] },
    { label: 'Police Stations', route: '/police-stations', icon: 'policestations', roles: [Role.SUPER_ADMIN, Role.ADMIN] },
    ...
    { label: 'Account Transactions', route: '/transactions', icon: 'transactions', roles: [Role.SUPER_ADMIN, Role.ADMIN, Role.BRANCH_MANAGER, Role.ACCOUNTANT, Role.CASHIER, Role.CUSTOMER_SERVICE] },
    { label: 'Cashier Transactions', route: '/transactions/cashier', icon: 'cashier', roles: [Role.SUPER_ADMIN, Role.ADMIN, Role.BRANCH_MANAGER, Role.ACCOUNTANT, Role.CASHIER] },
    ...
    { label: 'Cards', route: '/cards', icon: 'cards', roles: [Role.SUPER_ADMIN, Role.ADMIN, Role.BRANCH_MANAGER, Role.CUSTOMER_SERVICE] },
